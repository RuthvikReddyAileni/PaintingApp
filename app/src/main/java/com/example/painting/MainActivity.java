...
public class MainActivity extends AppCompatActivity  {
    ...
    // creating the object of type Drawiew
    // in order to get the reference of the View
    private Drawiew paint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paint = (Drawiew) findViewById(R.id.draw_view);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MainActivity.this,"Saved.Check in your gallery.",Toast.LENGTH_LONG).show();
        ...
        // to the init method of the Drawiew object
